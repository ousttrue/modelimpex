...
class IkLink(common.Diff):
    ...
    def __init__(
        ...
        bone_index: int,
        limit_angle: int,
        limit_min: common.Vector3 | None = None,
        limit_max: common.Vector3 | None = None,
    ):
...
class Bone(common.Diff):
    ...
    def __init__(
        ...
        layer: int,
        flag: int,
        tail_position: common.Vector3 | None = None,
        tail_index: int = -1,
        effect_index: int = -1,
        effect_factor: float = 0.0,
        fixed_axis: common.Vector3 | None = None,
        local_x_vector: common.Vector3 | None = None,
        local_z_vector: common.Vector3 | None = None,
        external_key: int = -1,
        ik: Ik | None = None,
    ):
        self.name = name
    ...
    def __str__(self) -> str:
        return "<pmx.Bone {name}>".format(name=self.name)
    ...
    def setFlag(self, flag: int, enable: bool) -> None:
        if enable:
            self.flag |= flag
        else:
            self.flag &= ~flag
    ...
    def getAfterPhysicsDeformFlag(self) -> int:
...
class Material(common.Diff):
    ...
    def hasFlag(self, mask: int) -> bool:
    ...
    def __str__(self) -> str:
        return "<pmx.Material {name}>".format(name=self.english_name)
...
class Sdef(common.Diff):
    ...
    __slots__ = ["index0", "index1", "weight0", "sdef_c", "sdef_r0", "sdef_r1"]
    ...
    def __init__(
        ...
        index1: int,
        weight0: float,
        sdef_c: common.Vector3,
        sdef_r0: common.Vector3,
        sdef_r1: common.Vector3,
    ):
        self.index0 = index0
        self.index1 = index1
        self.weight0 = weight0
...
class Morph(common.Diff):
    ...
    def __init__(self, name: str, english_name: str, panel: int, morph_type: int):
        self.name = name
        self.english_name = english_name
        self.panel = panel
...
class VertexMorphData(common.Diff):
    ...
    def __init__(self, vertex_index: int, position_offset: common.Vector3):
        self.vertex_index = vertex_index
        self.position_offset = position_offset

    def __eq__(self, rhs: object) -> bool:
        match rhs:
            case VertexMorphData():
                return (
...
class BoneMorphData(common.Diff):
    ...
    def __init__(
        self, bone_index: int, position: common.Vector3, rotation: common.Quaternion
    ):
        self.bone_index = bone_index
        self.position = position
...
class UVMorphData(common.Diff):
    ...
    def __init__(self, vertex_index: int, uv: common.Vector4):
        self.vertex_index = vertex_index
        self.uv = uv
    ...
    def __eq__(self, rhs: object) -> bool:
        match rhs:
            case UVMorphData():
                return self.vertex_index == rhs.vertex_index and self.uv == rhs.uv
            case _:
                return False
...
class MaterialMorphData(common.Diff):
    ...
    def __init__(
        ...
        edge_color: common.RGBA,
        edge_size: float,
        texture_factor: common.RGBA,
        sphere_texture_factor: common.RGBA,
        toon_texture_factor: common.RGBA,
    ):
...
class GroupMorphData(common.Diff):
    ...
    def __init__(self, morph_index: int, value: float):
...
class VertexMorph(Morph):
    def __init__(
        ...
        panel: int,
        morph_type: int,
        offsets: list[VertexMorphData],
    ):
        super().__init__(name, english_name, panel, morph_type)
...
class MaterialMorph(Morph):
    def __init__(
        ...
        panel: int,
        morph_type: int,
        offsets: list[MaterialMorphData],
    ):
        super().__init__(name, english_name, panel, morph_type)
        self.offsets = offsets
...
class DisplaySlot(common.Diff):
    ...
    def __init__(
        ...
        english_name: str,
        special_flag: int,
        references: list[tuple[int, int]] | None = None,
    ):
        self.name = name
        self.english_name = english_name
...
class RigidBody(common.Diff):
    ...
    def __str__(self) -> str:
        return "<pmx.RigidBody {name} shape:{type}>".format(
            name=self.english_name, type=self.shape_type
        )
...
class Model(common.Diff):
    ...
    def __init__(
        ...
        self.bones: list[Bone] = [
            Bone("センター", "center", common.Vector3(), -1, 0, 0)
        ]
        self.morphs: list[Morph] = []
        self.display_slots: list[DisplaySlot] = [
            DisplaySlot("Root", "Root", 1, [(0, 0)])
        ]
