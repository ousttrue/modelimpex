...
class ByteReader:
    ...
    def read_chunk(self) -> tuple[bytes, bytes]:
        ...
        chunk_body = self.read_bytes(int.from_bytes(chunk_length, byteorder="little"))
...
def to_glb(gltf: gltf_json_type.glTF, bin: bytes):
    """
    ...
    with io.BytesIO() as bs:
        ...
        size = 12 + chunk_size_with_padding(json_body) + chunk_size_with_padding(bin)
